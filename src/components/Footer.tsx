            ...
            <nav className="flex flex-col gap-2">
              {quickLinks.map((link) => (
                <button
                  ...
                  className="text-xs sm:text-sm text-white/80 hover:text-primary transition-colors text-left"
                >
                  {link.label}
                </button>
              ))}
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-xs sm:text-sm text-white/80 hover:text-primary transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 text-xs sm:text-sm text-white/80 hover:text-primary transition-colors break-all"
              >
